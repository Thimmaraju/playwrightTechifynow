...
test('Working with check box - example 4', async ({ page }) => {

    await page.goto('https://testautomationpractice.blogspot.com/')
    const Checkboxes = ["#sunday", "#tuesday", "#thursday"]


    for (let elemet of Checkboxes) {

        await page.locator(elemet).check()
    }
})


// cy.get(commonlocator).check(["#sunday", "#tuesday", "#thursday"])
