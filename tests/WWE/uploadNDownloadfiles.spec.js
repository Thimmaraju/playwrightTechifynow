...
test.describe('Automation - Working With Elements', () => {
    ...
    test('Playwright Test Case - upload file', async ({ page }) => {
        ...
        await page.locator('#file-upload').setInputFiles('./testData/uploadfiles/11. Seven-Principles.png')
    ...
    test('Upload Multiple files and assert', async ({ page }) => {
        ...
        await page.locator('input[type="file"]').setInputFiles(['./testData/uploadfiles/11. Seven-Principles.png', './testData/uploadfiles/16. Levels of testing.png'])

        await expect(page.locator('p.name').nth(0)).toHaveText('11. Seven-Principles.png')
        await expect(page.locator('p.name').nth(1)).toHaveText('16. Levels of testing.png')
